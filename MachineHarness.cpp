...
uint8_t loadProg (const char* path) {
  ...
  //uint8_t prog[] = {0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x10, 0x02, 0x10, 0x02, 0x33, 0xEE}; //(print (+ 2B 2B))
  ...
  //uint8_t prog[] = {0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x10, 0x02, 0x10, 0x02, 0x33, 0xEE}; //(print (+ 2B 2B))
  //uint8_t prog[] = {0x00, 0x00, 0x13, 0x00, 0x00, 0x00, 0x10, 0x01, 0x00, 0x11, 0x88, 0x00, 0x01, 0x61, 0x62, 0x63, 0x00, 0x11, 0x99, 0x00, 0xBB, 0xCC, 0xEE}; //(print (nth 1B [136W "abc" 153W]))
  uint8_t prog[] = {0x00, 0x00, 0x1A, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00, 0x10, 0x01, 0x00, 0x10, 0x88, 0x00, 0x01, 0x61, 0x62, 0x63, 0x00, 0x10, 0x7B, 0xBB, 0x11, 0x99, 0x00, 0xBB, 0xCC, 0xCC, 0xEE}; //(print (nth 0B (nth 1B [136B ["abc" 123B] 153W])))
  //uint8_t prog[] = {0x00, 0x00, 0x13, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x01, 0x61, 0x62, 0x63, 0x00, 0xBB, 0xBB, 0xCC, 0xCC, 0xEE}; //(print (nth 0B (nth 0B [["abc"]])))
